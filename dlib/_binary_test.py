...
class _binary_test(__pybind11_builtins.pybind11_object):
    # no doc
    ...
    class1_accuracy = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """A value between 0 and 1, measures accuracy on the +1 class."""

    class2_accuracy = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """A value between 0 and 1, measures accuracy on the -1 class."""
